...
$$.Closure$0 = [U, {"": "Closure;call$0,$name"}];

$$.Closure$1 = [U, {"": "Closure;call$1,$name"}];
...
["PathfindingVisualizer", "pathfinding_visualizer.dart", , U, {
main: function() {
  $.canvas = document.querySelector("#astar");
  U.resizeCanvas();
  $.context = H.interceptedTypeCast(J.getContext$1$x($.canvas, "2d"), "$isCanvasRenderingContext2D");
  var t1 = new U.Map("#EEEEEE", "#2D2D30", "#00CC00", "#4444FF", 4, 2, $.context, null, H.Primitives_parseInt($.mapWidth, null, null), H.Primitives_parseInt($.mapHeight, null, null), H.Primitives_parseInt($.mapScale, null, null));
  t1.initObstacleMap$0();
  t1.clear$0(t1);
  $.map = t1;
  $.start = U.AStarNode$(0, 0, 0, null);
  $.goal = U.AStarNode$(J.$sub$n($.map.width, 1), J.$sub$n($.map.height, 1), 0, null);
  U.registerEvents($.canvas);
},
...
registerEvents: function(canvas) {
  ...
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(U.canvasMouseDown$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_mouseup._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(U.canvasMouseUp$closure), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
  t1 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_mousemove._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(U.canvasMouseMove$closure), t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_contextmenu._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new U.registerEvents_closure()), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
  ...
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.registerEvents_closure0()), t1._useCapture);
  ...
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(U.clearMap$closure), t2._useCapture);
...
resizeMap: function() {
  ...
  $.goal = new U.MapNode(J.$sub$n($.map.width, 1), J.$sub$n($.map.height, 1));
},
...
run: function() {
  ...
  U.resizeMap();
  $.map.clearPath$0();
  new U.AStar(1, 1.414, $.map).run$2($.start, $.goal);
},
...
Array2d: {"": "Object;array-,defaultValue-",
  ...
  set$height$bailout: function(state0, v) {
    var t1, x, t2;
    while (true) {
      t1 = C.JSArray_methods.get$first(this.array).length;
      if (typeof v !== "number")
        throw H.iae(v);
      if (!(t1 > v))
        break;
...
Array2d$: function(width, height, defaultValue, $T) {
  var t1 = new U.Array2d(null, defaultValue);
...
AStar: {"": "Object;COST_STRAIGHT-,COST_DIAGONAL-,map-",
  run$2: function(start, goal) {
    var $closed, $open, t1, t2, lowestF, i, t3, t4, current, info, t5, neighbors, index;
    $closed = [];
    $open = [start];
    ...
    for (t1 = this.map; t2 = $open.length, t2 > 0;) {
      for (lowestF = 0, i = 1; i < t2; ++i) {
        t3 = $open[i].get$f();
        if (lowestF < 0 || lowestF >= t2)
          throw H.ioore($open, lowestF);
        t4 = $open[lowestF].get$f();
        if (typeof t3 !== "number")
          throw t3.$lt();
        if (typeof t4 !== "number")
          throw H.iae(t4);
      ...
      if (t2.$eq(current, goal)) {
        t1.draw$5($closed, $open, current, start, goal);
        info = "Map size = " + H.S(t1.width) + "x" + H.S(t1.height) + ("Total number of nodes = " + H.S(J.$mul$n(t1.width, t1.height))) + ("Number of nodes in open list = " + $open.length) + ("Number of nodes in closed list = " + $closed.length);
      ...
      t5 = t1.context;
      t5.fillStyle = t4;
      t3 = J.$mul$n(t3, t1.scale);
      t2 = J.$mul$n(t2, t1.scale);
      t4 = t1.scale;
      t5.fillRect(t3, t2, t4, t4);
        ...
        if (this.indexOfNode$2($closed, neighbors[i]) === -1) {
          ...
          if (index === -1) {
            if (i >= neighbors.length)
              throw H.ioore(neighbors, i);
            t2 = neighbors[i];
            t2.f = t2.g + this.diagonalDistance$2(t2, goal);
            if (i >= neighbors.length)
              throw H.ioore(neighbors, i);
            ...
            if (t3 < $open[index].get$g()) {
              t2.f = t3 + this.diagonalDistance$2(t2, goal);
              if (i >= neighbors.length)
                throw H.ioore(neighbors, i);
              t2 = neighbors[i];
  ...
  neighborNodes$1: function(n) {
    var neighbors, t1, t2, t3, t4, t5, t6, t7, t8, t9;
    neighbors = P.List_List(null, U.AStarNode);
    neighbors.$builtinTypeInfo = [U.AStarNode];
    t1 = J.getInterceptor$x(n);
    t2 = t1.get$x(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(1, neighbors, n, t1, t2);
    if (t2 > 0) {
      t3 = this.map;
      t4 = t2 - 1;
      t5 = t1.get$y(n);
      if (typeof t5 !== "number")
        return this.neighborNodes$1$bailout(3, neighbors, n, t1, t3, t4, t5);
      t3.toString;
      if (t4 >= 0) {
        t6 = t3.width;
        if (typeof t6 !== "number")
        ...
        if (t4 < t6)
          if (t5 >= 0) {
            t6 = t3.height;
            if (typeof t6 !== "number")
              return this.neighborNodes$1$bailout(4, neighbors, n, t1, t3, C.JSNumber_methods, t5, t6);
            t6 = t5 < t6;
          } else
            t6 = false;
        else
      ...
      if (t6) {
        t6 = t3.obstacleMap;
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(5, neighbors, n, t1, t3, t6, t2);
        t6 = t6.array;
        ...
        t2 = false;
      if (t2) {
        t2 = new U.AStarNode(n, null, null, t4, t5);
        t4 = t2.parent;
        t4 = t4 != null ? t4.get$g() : 0;
        t2.g = t4 + this.COST_STRAIGHT;
        neighbors.push(t2);
      }
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(7, neighbors, n, t1, t3, t2);
      if (t2 > 0) {
        t4 = t1.get$x(n);
        if (typeof t4 !== "number")
          return this.neighborNodes$1$bailout(8, neighbors, n, t1, t3, t4);
        t5 = t4 - 1;
        t6 = t2 - 1;
        if (t5 >= 0) {
          t7 = t3.width;
        ...
        if (t7) {
          t7 = t3.obstacleMap;
          if (t4 !== (t4 | 0))
            return this.neighborNodes$1$bailout(10, neighbors, n, t1, t3, t7, t4);
          t7 = t7.array;
          if (t5 >>> 0 !== t5 || t5 >= t7.length)
            throw H.ioore(t7, t5);
          t5 = t7[t5];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(11, neighbors, n, t1, t3, t2, t5);
      ...
      if (t4) {
        t4 = t1.get$x(n);
        if (typeof t4 !== "number")
          return this.neighborNodes$1$bailout(12, neighbors, n, t1, t3, t4);
        t5 = t4 - 1;
        if (t5 >= 0) {
          t6 = t3.width;
          if (typeof t6 !== "number")
          ...
          if (t5 < t6)
            if (t2 >= 0) {
              t6 = t3.height;
              if (typeof t6 !== "number")
                return this.neighborNodes$1$bailout(14, neighbors, n, t1, t3, C.JSNumber_methods, t2, t6);
              t6 = t2 < t6;
            } else
              t6 = false;
          else
        ...
        if (t6) {
          ...
          if (t4 >= 0) {
            t7 = t3.width;
            if (typeof t7 !== "number")
              return this.neighborNodes$1$bailout(17, neighbors, n, t1, t3, t4, t6, C.JSNumber_methods, t7);
            if (t4 < t7)
              if (t6 >= 0) {
                t7 = t3.height;
                if (typeof t7 !== "number")
          ...
          if (t7) {
            t7 = t3.obstacleMap;
            if (t4 !== (t4 | 0))
              return this.neighborNodes$1$bailout(18, neighbors, n, t1, t3, t7, t4);
            t7 = t7.array;
            t8 = t7.length;
            if (t5 >>> 0 !== t5 || t5 >= t8)
              throw H.ioore(t7, t5);
            t9 = t7[t5];
            if (t2 >>> 0 !== t2 || t2 >= t9.length)
              throw H.ioore(t9, t2);
            if (t9[t2] === true) {
              if (t4 >>> 0 !== t4 || t4 >= t8)
                throw H.ioore(t7, t4);
          ...
          t4 = false;
        if (t4) {
          t2 = new U.AStarNode(n, null, null, t5, t2 - 1);
          t4 = t2.parent;
          t4 = t4 != null ? t4.get$g() : 0;
          t2.g = t4 + this.COST_DIAGONAL;
          neighbors.push(t2);
        }
      }
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(21, neighbors, n, t1, t3, t2);
      t4 = t3.height;
      if (typeof t4 !== "number")
        return this.neighborNodes$1$bailout(22, neighbors, n, t1, t3, t2, t4);
      t5 = t2 < t4;
      if (t5) {
        t6 = t1.get$x(n);
        if (typeof t6 !== "number")
          return this.neighborNodes$1$bailout(23, neighbors, n, t1, t3, t6);
        t7 = t6 - 1;
        t8 = t2 + 1;
        if (t7 >= 0) {
          t9 = t3.width;
        ...
        if (t9) {
          t9 = t3.obstacleMap;
          if (t6 !== (t6 | 0))
            return this.neighborNodes$1$bailout(25, neighbors, n, t1, t3, t9, t6);
          t9 = t9.array;
          if (t7 >>> 0 !== t7 || t7 >= t9.length)
            throw H.ioore(t9, t7);
          t7 = t9[t7];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(26, neighbors, n, t1, t3, t2, t7);
      ...
      if (t6) {
        t6 = t1.get$x(n);
        if (typeof t6 !== "number")
          return this.neighborNodes$1$bailout(27, neighbors, n, t1, t3, t6);
        t7 = t6 - 1;
        if (t7 >= 0) {
          t8 = t3.width;
          if (typeof t8 !== "number")
        ...
        if (t5) {
          ...
          if (t6 >= 0) {
            t8 = t3.width;
            if (typeof t8 !== "number")
              return this.neighborNodes$1$bailout(32, neighbors, n, t1, t3, t6, t5, C.JSNumber_methods, t8);
            t4 = t6 < t8 && t5 >= 0 && t5 < t4;
          } else
            t4 = false;
          if (t4) {
            t4 = t3.obstacleMap;
            if (t6 !== (t6 | 0))
              return this.neighborNodes$1$bailout(33, neighbors, n, t1, t3, t4, t6);
            t4 = t4.array;
            t3 = t4.length;
            if (t7 >>> 0 !== t7 || t7 >= t3)
              throw H.ioore(t4, t7);
          ...
          t3 = false;
        if (t3) {
          t2 = new U.AStarNode(n, null, null, t7, t2 + 1);
          t3 = t2.parent;
    ...
    t2 = t1.get$x(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(36, neighbors, n, t1, t2);
    t3 = this.map;
    t4 = t3.width;
    if (typeof t4 !== "number")
      return this.neighborNodes$1$bailout(37, neighbors, n, t1, t2, t3, t4);
    if (t2 < t4 - 1) {
      t5 = t2 + 1;
      t6 = t1.get$y(n);
      if (typeof t6 !== "number")
        return this.neighborNodes$1$bailout(39, neighbors, n, t1, t5, t3, t6);
      t3.toString;
      if (t5 >= 0)
        if (t5 < t4)
          if (t6 >= 0) {
            t4 = t3.height;
            if (typeof t4 !== "number")
              return this.neighborNodes$1$bailout(40, neighbors, n, t1, C.JSNumber_methods, t3, t6, t4);
            t4 = t6 < t4;
          } else
            t4 = false;
        else
      ...
      if (t4) {
        t4 = t3.obstacleMap;
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(41, neighbors, n, t1, t4, t3, t2);
        t4 = t4.array;
        ...
        t2 = false;
      if (t2) {
        t2 = new U.AStarNode(n, null, null, t5, t6);
        t4 = t2.parent;
        t4 = t4 != null ? t4.get$g() : 0;
        t2.g = t4 + this.COST_STRAIGHT;
        neighbors.push(t2);
      ...
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(43, neighbors, n, t1, t2, t3);
      if (t2 > 0) {
        t4 = t1.get$x(n);
        if (typeof t4 !== "number")
          return this.neighborNodes$1$bailout(44, neighbors, n, t1, t4, t3);
        t5 = t4 + 1;
        t6 = t2 - 1;
        if (t5 >= 0) {
          t7 = t3.width;
        ...
        if (t7) {
          t7 = t3.obstacleMap;
          if (t4 !== (t4 | 0))
            return this.neighborNodes$1$bailout(46, neighbors, n, t1, t7, t3, t4);
          t7 = t7.array;
          if (t5 >>> 0 !== t5 || t5 >= t7.length)
            throw H.ioore(t7, t5);
          t5 = t7[t5];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(47, neighbors, n, t1, t2, t3, t5);
          if (t6 >>> 0 !== t6 || t6 >= t5.length)
            throw H.ioore(t5, t6);
          t6 = t5[t6] === true;
          t4 = t6;
      ...
      if (t4) {
        t4 = t1.get$x(n);
        if (typeof t4 !== "number")
          return this.neighborNodes$1$bailout(48, neighbors, n, t1, t4, t3);
        t5 = t4 + 1;
        if (t5 >= 0) {
          t6 = t3.width;
          if (typeof t6 !== "number")
          ...
          if (t5 < t6)
            if (t2 >= 0) {
              t6 = t3.height;
              if (typeof t6 !== "number")
                return this.neighborNodes$1$bailout(50, neighbors, n, t1, C.JSNumber_methods, t3, t2, t6);
              t6 = t2 < t6;
            } else
              t6 = false;
          else
        ...
        if (t6) {
          ...
          if (t4 >= 0) {
            t7 = t3.width;
            if (typeof t7 !== "number")
              return this.neighborNodes$1$bailout(53, neighbors, n, t1, t4, t3, t6, C.JSNumber_methods, t7);
            if (t4 < t7)
              if (t6 >= 0) {
                t7 = t3.height;
                if (typeof t7 !== "number")
          ...
          if (t7) {
            t7 = t3.obstacleMap;
            if (t4 !== (t4 | 0))
              return this.neighborNodes$1$bailout(54, neighbors, n, t1, t7, t3, t4);
            t7 = t7.array;
            t8 = t7.length;
            if (t5 >>> 0 !== t5 || t5 >= t8)
              throw H.ioore(t7, t5);
      ...
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(57, neighbors, n, t1, t2, t3);
      t4 = t3.height;
      if (typeof t4 !== "number")
        return this.neighborNodes$1$bailout(58, neighbors, n, t1, t2, t3, t4);
      t5 = t2 < t4;
      if (t5) {
        t6 = t1.get$x(n);
        if (typeof t6 !== "number")
          return this.neighborNodes$1$bailout(59, neighbors, n, t1, t6, t3);
        t7 = t6 + 1;
        t8 = t2 + 1;
        if (t7 >= 0) {
          t9 = t3.width;
        ...
        if (t9) {
          t9 = t3.obstacleMap;
          if (t6 !== (t6 | 0))
            return this.neighborNodes$1$bailout(61, neighbors, n, t1, t9, t3, t6);
          t9 = t9.array;
          if (t7 >>> 0 !== t7 || t7 >= t9.length)
            throw H.ioore(t9, t7);
          t7 = t9[t7];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(62, neighbors, n, t1, t2, t3, t7);
          if (t8 >>> 0 !== t8 || t8 >= t7.length)
            throw H.ioore(t7, t8);
          t8 = t7[t8] === true;
          t6 = t8;
      ...
      if (t6) {
        t6 = t1.get$x(n);
        if (typeof t6 !== "number")
          return this.neighborNodes$1$bailout(63, neighbors, n, t1, t6, t3);
        t7 = t6 + 1;
        if (t7 >= 0) {
          t8 = t3.width;
          if (typeof t8 !== "number")
        ...
        if (t5) {
          ...
          if (t6 >= 0) {
            t8 = t3.width;
            if (typeof t8 !== "number")
              return this.neighborNodes$1$bailout(68, neighbors, n, t1, t6, t3, t5, C.JSNumber_methods, t8);
            t4 = t6 < t8 && t5 >= 0 && t5 < t4;
          } else
            t4 = false;
          if (t4) {
            t4 = t3.obstacleMap;
            if (t6 !== (t6 | 0))
              return this.neighborNodes$1$bailout(69, neighbors, n, t1, t4, t3, t6);
            t4 = t4.array;
            t8 = t4.length;
            if (t7 >>> 0 !== t7 || t7 >= t8)
              throw H.ioore(t4, t7);
    ...
    t2 = t1.get$y(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(72, neighbors, n, t1, t2, t3);
    if (t2 > 0) {
      t4 = t1.get$x(n);
      if (typeof t4 !== "number")
        return this.neighborNodes$1$bailout(73, neighbors, n, t1, t4, t3);
      t5 = t2 - 1;
      t3.toString;
      if (t4 >= 0) {
        t6 = t3.width;
        if (typeof t6 !== "number")
          return this.neighborNodes$1$bailout(75, neighbors, n, t1, t4, t3, t5, C.JSNumber_methods, t6);
        if (t4 < t6)
          if (t5 >= 0) {
            t6 = t3.height;
            if (typeof t6 !== "number")
        ...
        t6 = false;
      if (t6) {
        t6 = t3.obstacleMap.array;
        if (t4 >>> 0 !== t4 || t4 >= t6.length)
          throw H.ioore(t6, t4);
        t4 = t6[t4];
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(76, neighbors, n, t1, t2, t3, t4);
        if (t5 >>> 0 !== t5 || t5 >= t4.length)
          throw H.ioore(t4, t5);
        t5 = t4[t5] === true;
        t4 = t5;
      ...
      t4 = false;
    if (t4) {
      t2 = new U.AStarNode(n, null, null, t1.get$x(n), t2 - 1);
      t4 = t2.parent;
      t4 = t4 != null ? t4.get$g() : 0;
      t2.g = t4 + this.COST_STRAIGHT;
      neighbors.push(t2);
    ...
    t2 = t1.get$y(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(78, neighbors, n, t1, t2, t3);
    t4 = t3.height;
    if (typeof t4 !== "number")
      return this.neighborNodes$1$bailout(79, neighbors, n, t1, t2, t3, t4);
    if (t2 < t4 - 1) {
      t5 = t1.get$x(n);
      if (typeof t5 !== "number")
        return this.neighborNodes$1$bailout(80, neighbors, n, t1, t5, t3);
      t6 = t2 + 1;
      t3.toString;
      if (t5 >= 0) {
        t7 = t3.width;
        if (typeof t7 !== "number")
          return this.neighborNodes$1$bailout(82, neighbors, n, t1, t5, t3, t6, C.JSNumber_methods, t7);
        t4 = t5 < t7 && t6 >= 0 && t6 < t4;
      } else
        t4 = false;
      if (t4) {
        t3 = t3.obstacleMap.array;
        if (t5 >>> 0 !== t5 || t5 >= t3.length)
          throw H.ioore(t3, t5);
        t5 = t3[t5];
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(83, neighbors, n, t1, t2, t5);
        if (t6 >>> 0 !== t6 || t6 >= t5.length)
          throw H.ioore(t5, t6);
        t6 = t5[t6] === true;
        t3 = t6;
      ...
      t3 = false;
    if (t3) {
      t1 = new U.AStarNode(n, null, null, t1.get$x(n), t2 + 1);
      t2 = t1.parent;
  ...
  neighborNodes$1$bailout: function(state0, neighbors, n, t1, t2, t3, t4, t5, t6) {
    switch (state0) {
      case 0:
        neighbors = P.List_List(null, U.AStarNode);
        neighbors.$builtinTypeInfo = [U.AStarNode];
      ...
      default:
        if (state0 === 35 || state0 === 34 || state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 29 || state0 === 28 || state0 === 27 || state0 === 26 || state0 === 25 || state0 === 24 || state0 === 23 || state0 === 22 || state0 === 21 || state0 === 20 || state0 === 19 || state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 2 || state0 === 0 && J.$gt$n(t2, 0))
          switch (state0) {
            ...
            case 4:
              if (state0 === 4 || state0 === 0 && t5.$ge(t3, 0))
                switch (state0) {
                  case 0:
                    t6 = t2.width;
                    if (typeof t6 !== "number")
                      throw H.iae(t6);
                  case 4:
                    if (state0 === 4 || state0 === 0 && t5.$lt(t3, t6))
                      switch (state0) {
                        case 0:
                          t3 = J.getInterceptor$n(t4);
                        case 4:
                          if (state0 === 4 || state0 === 0 && t3.$ge(t4, 0))
                            switch (state0) {
                              case 0:
                                t5 = t2.height;
                              case 4:
            ...
            case 6:
              if (state0 === 6 || state0 === 0 && t3)
                switch (state0) {
                  ...
                  case 6:
                    state0 = 0;
                    t3 = new U.AStarNode(n, null, null, J.$sub$n(t3, 1), t1.get$y(n));
                    t4 = t3.parent;
                    t4 = t4 != null ? t4.get$g() : 0;
                    t3.g = t4 + this.COST_STRAIGHT;
                    neighbors.push(t3);
                }
              t3 = t1.get$y(n);
            case 7:
              state0 = 0;
            default:
              if (state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 0 && J.$gt$n(t3, 0))
                switch (state0) {
                  case 0:
                    t3 = t1.get$x(n);
                  case 8:
                  ...
                  case 9:
                    ...
                    if (t5.$ge(t3, 0)) {
                      ...
                      t3 = false;
                  default:
                    if (state0 === 11 || state0 === 10 || state0 === 0 && t3)
                      switch (state0) {
                        case 0:
                          t3 = t2.obstacleMap;
                          t4 = t1.get$x(n);
            ...
            case 19:
            case 20:
              if (state0 === 20 || state0 === 19 || state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 0 && t3)
                switch (state0) {
                  case 0:
                    t3 = t1.get$x(n);
                  case 12:
                  ...
                  case 13:
                    ...
                    t5 = J.getInterceptor$n(t3);
                  case 14:
                    if (state0 === 14 || state0 === 0 && t5.$ge(t3, 0))
                      switch (state0) {
                        case 0:
                          t6 = t2.width;
                          if (typeof t6 !== "number")
                            throw H.iae(t6);
                        case 14:
                          if (state0 === 14 || state0 === 0 && t5.$lt(t3, t6))
                            switch (state0) {
                              case 0:
                                t3 = J.getInterceptor$n(t4);
                              case 14:
                                if (state0 === 14 || state0 === 0 && t3.$ge(t4, 0))
                                  switch (state0) {
                                    case 0:
                                      t5 = t2.height;
                                    case 14:
                      ...
                      t3 = false;
                  default:
                    if (state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 0 && t3)
                      switch (state0) {
                        case 0:
                          t3 = t1.get$x(n);
                        case 15:
                        ...
                        case 16:
                          ...
                          t5 = J.getInterceptor$n(t3);
                        case 17:
                          if (state0 === 17 || state0 === 0 && t5.$ge(t3, 0))
                            switch (state0) {
                              case 0:
                                t6 = t2.width;
                              case 17:
                  ...
                  case 19:
                  case 20:
                    if (state0 === 20 || state0 === 19 || state0 === 0 && t3)
                      switch (state0) {
                        case 0:
                          t3 = t1.get$x(n);
                        case 19:
                        ...
                        case 20:
                          state0 = 0;
                          t4 = new U.AStarNode(n, null, null, t3, J.$sub$n(t4, 1));
                          t3 = t4.parent;
                          t3 = t3 != null ? t3.get$g() : 0;
                          t4.g = t3 + this.COST_DIAGONAL;
                          neighbors.push(t4);
                      }
                }
              t3 = t1.get$y(n);
            ...
            case 25:
            case 26:
              if (state0 === 26 || state0 === 25 || state0 === 24 || state0 === 23 || state0 === 0 && J.$lt$n(t3, t4))
                switch (state0) {
                  case 0:
                    t3 = t1.get$x(n);
                  case 23:
                  ...
                  case 24:
                    ...
                    if (t5.$ge(t3, 0)) {
                      ...
                      t3 = false;
                  default:
                    if (state0 === 26 || state0 === 25 || state0 === 0 && t3)
                      switch (state0) {
                        case 0:
                          t3 = t2.obstacleMap;
                          t4 = t1.get$x(n);
            ...
            case 34:
            case 35:
              if (state0 === 35 || state0 === 34 || state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 29 || state0 === 28 || state0 === 27 || state0 === 0 && t3)
                switch (state0) {
                  case 0:
                    t3 = t1.get$x(n);
                  case 27:
                  ...
                  case 28:
                    ...
                    t5 = J.getInterceptor$n(t3);
                  case 29:
                    if (state0 === 29 || state0 === 0 && t5.$ge(t3, 0))
                      switch (state0) {
                        case 0:
                          t6 = t2.width;
                          if (typeof t6 !== "number")
                            throw H.iae(t6);
                        case 29:
                          if (state0 === 29 || state0 === 0 && t5.$lt(t3, t6))
                            switch (state0) {
                              case 0:
                                t3 = J.getInterceptor$n(t4);
                              case 29:
                                if (state0 === 29 || state0 === 0 && t3.$ge(t4, 0))
                                  switch (state0) {
                                    case 0:
                                      t5 = t2.height;
                                    case 29:
                      ...
                      t3 = false;
                  default:
                    if (state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 0 && t3)
                      switch (state0) {
                        case 0:
                          t3 = t1.get$x(n);
                        case 30:
                        ...
                        case 31:
                          ...
                          t5 = J.getInterceptor$n(t3);
                        case 32:
                          if (state0 === 32 || state0 === 0 && t5.$ge(t3, 0))
                            switch (state0) {
                              case 0:
                                t6 = t2.width;
                              case 32:
                  ...
                  case 35:
                    if (state0 === 35 || state0 === 34 || state0 === 0 && t2)
                      switch (state0) {
                        ...
                        case 35:
                          state0 = 0;
                          t3 = new U.AStarNode(n, null, null, t2, J.$add$ns(t3, 1));
                          t2 = t3.parent;
                          t2 = t2 != null ? t2.get$g() : 0;
      ...
      case 71:
        if (state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 65 || state0 === 64 || state0 === 63 || state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 58 || state0 === 57 || state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 49 || state0 === 48 || state0 === 47 || state0 === 46 || state0 === 45 || state0 === 44 || state0 === 43 || state0 === 42 || state0 === 41 || state0 === 40 || state0 === 39 || state0 === 38 || state0 === 0 && J.$lt$n(t2, J.$sub$n(t4, 1)))
          switch (state0) {
            ...
            case 40:
              if (state0 === 40 || state0 === 0 && t5.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t6 = t3.width;
                    if (typeof t6 !== "number")
                      throw H.iae(t6);
                  case 40:
                    if (state0 === 40 || state0 === 0 && t5.$lt(t2, t6))
                      switch (state0) {
                        case 0:
                          t2 = J.getInterceptor$n(t4);
                        case 40:
                          if (state0 === 40 || state0 === 0 && t2.$ge(t4, 0))
                            switch (state0) {
                              case 0:
                                t5 = t3.height;
                              case 40:
            ...
            case 42:
              if (state0 === 42 || state0 === 0 && t2)
                switch (state0) {
                  ...
                  case 42:
                    state0 = 0;
                    t2 = new U.AStarNode(n, null, null, J.$add$ns(t2, 1), t1.get$y(n));
                    t4 = t2.parent;
                    t4 = t4 != null ? t4.get$g() : 0;
                    t2.g = t4 + this.COST_STRAIGHT;
                    neighbors.push(t2);
              ...
              if (state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 49 || state0 === 48 || state0 === 0 && t2)
                switch (state0) {
                  ...
                  case 49:
                    ...
                    t5 = J.getInterceptor$n(t2);
                  case 50:
                    if (state0 === 50 || state0 === 0 && t5.$ge(t2, 0))
                      switch (state0) {
                        case 0:
                          t6 = t3.width;
                          if (typeof t6 !== "number")
                            throw H.iae(t6);
                        case 50:
                          if (state0 === 50 || state0 === 0 && t5.$lt(t2, t6))
                            switch (state0) {
                              case 0:
                                t2 = J.getInterceptor$n(t4);
                              case 50:
                                if (state0 === 50 || state0 === 0 && t2.$ge(t4, 0))
                                  switch (state0) {
                                    case 0:
                                      t5 = t3.height;
                                    case 50:
                    ...
                    if (state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 0 && t2)
                      switch (state0) {
                        ...
                        case 52:
                          ...
                          t5 = J.getInterceptor$n(t2);
                        case 53:
                          if (state0 === 53 || state0 === 0 && t5.$ge(t2, 0))
                            switch (state0) {
                              case 0:
                                t6 = t3.width;
                              case 53:
                  ...
                  case 56:
                    if (state0 === 56 || state0 === 55 || state0 === 0 && t2)
                      switch (state0) {
                        ...
                        case 56:
                          state0 = 0;
                          t4 = new U.AStarNode(n, null, null, t2, J.$sub$n(t4, 1));
                          t2 = t4.parent;
                          t2 = t2 != null ? t2.get$g() : 0;
                          t4.g = t2 + this.COST_DIAGONAL;
                          neighbors.push(t4);
                      }
                }
              t2 = t1.get$y(n);
            ...
            case 61:
            case 62:
              if (state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 0 && J.$lt$n(t2, t4))
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 59:
              ...
              if (state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 65 || state0 === 64 || state0 === 63 || state0 === 0 && t2)
                switch (state0) {
                  ...
                  case 64:
                    ...
                    t5 = J.getInterceptor$n(t2);
                  case 65:
                    if (state0 === 65 || state0 === 0 && t5.$ge(t2, 0))
                      switch (state0) {
                        case 0:
                          t6 = t3.width;
                          if (typeof t6 !== "number")
                            throw H.iae(t6);
                        case 65:
                          if (state0 === 65 || state0 === 0 && t5.$lt(t2, t6))
                            switch (state0) {
                              case 0:
                                t2 = J.getInterceptor$n(t4);
                              case 65:
                                if (state0 === 65 || state0 === 0 && t2.$ge(t4, 0))
                                  switch (state0) {
                                    case 0:
                                      t5 = t3.height;
                                    case 65:
                    ...
                    if (state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 0 && t2)
                      switch (state0) {
                        ...
                        case 67:
                          ...
                          t5 = J.getInterceptor$n(t2);
                        case 68:
                          if (state0 === 68 || state0 === 0 && t5.$ge(t2, 0))
                            switch (state0) {
                              case 0:
                                t6 = t3.width;
                              case 68:
                  ...
                  case 71:
                    if (state0 === 71 || state0 === 70 || state0 === 0 && t2)
                      switch (state0) {
                        ...
                        case 71:
                          state0 = 0;
                          t4 = new U.AStarNode(n, null, null, t2, J.$add$ns(t4, 1));
                          t2 = t4.parent;
                          t2 = t2 != null ? t2.get$g() : 0;
                          t4.g = t2 + this.COST_DIAGONAL;
                          neighbors.push(t4);
        ...
        if (state0 === 76 || state0 === 75 || state0 === 74 || state0 === 73 || state0 === 0 && J.$gt$n(t2, 0))
          switch (state0) {
            ...
            case 74:
              ...
              t5 = J.getInterceptor$n(t2);
            case 75:
              if (state0 === 75 || state0 === 0 && t5.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t6 = t3.width;
                  case 75:
      ...
      case 82:
      case 83:
        if (state0 === 83 || state0 === 82 || state0 === 81 || state0 === 80 || state0 === 0 && J.$lt$n(t2, J.$sub$n(t4, 1)))
          switch (state0) {
            case 0:
              t2 = t1.get$x(n);
            case 80:
            ...
            case 81:
              ...
              t5 = J.getInterceptor$n(t2);
            case 82:
              if (state0 === 82 || state0 === 0 && t5.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t6 = t3.width;
                  case 82:
      ...
      case 84:
        if (state0 === 84 || state0 === 0 && t2)
          switch (state0) {
            ...
            case 84:
              state0 = 0;
              t1 = new U.AStarNode(n, null, null, t2, J.$add$ns(t1, 1));
              t2 = t1.parent;
              t2 = t2 != null ? t2.get$g() : 0;
              t1.g = t2 + this.COST_STRAIGHT;
              neighbors.push(t1);
...
AStarNode: {"": "MapNode;parent>-,g<-,f@-,x-,y-",
  AStarNode$4$cost$parent: function(x, y, cost, $parent) {
    var t1 = this.parent;
    this.g = (t1 != null ? t1.get$g() : 0) + cost;
  },
  static: {
AStarNode$: function(x, y, cost, $parent) {
  var t1 = new U.AStarNode($parent, null, null, x, y);
  t1.AStarNode$4$cost$parent(x, y, cost, $parent);
  return t1;
}}

},

Map: {"": "Object;BACKGROUND_COLOR-,OBSTACLE_COLOR-,PATH_COLOR-,VISITED_COLOR-,PATH_WIDTH-,OBSTACLE_BRUSH_SIZE-,context-,obstacleMap-,width-,height-,scale-",
  initObstacleMap$0: function() {
    this.obstacleMap = U.Array2d$(this.width, this.height, true, J.JSBool);
  },
  ...
  placeObstacles$1: function(e) {
    ...
    for (t2 = this.OBSTACLE_BRUSH_SIZE, x = mouseX - t2, t4 = mouseX + t2, y = mouseY - t2, t2 = mouseY + t2, t5 = this.BACKGROUND_COLOR, t6 = this.OBSTACLE_COLOR; x <= t4; ++x)
  ...
  drawNode$3: function(x, y, color) {
    var t1, t2, t3, t4;
    t1 = this.context;
    t1.fillStyle = color;
    t2 = J.$mul$n(x, this.scale);
    t3 = J.$mul$n(y, this.scale);
    t4 = this.scale;
  ...
  draw$5: function($closed, $open, foundGoalNode, start, goal) {
    var t1, t2, t3;
    t1 = this.PATH_COLOR;
    this.drawNode$3(goal.x, goal.y, t1);
    this.drawNode$3(start.x, start.y, t1);
    t2 = this.context;
    t2.beginPath();
    t3 = J.getInterceptor$x(foundGoalNode);
    t2.moveTo(J.$mul$n(J.$add$ns(t3.get$x(foundGoalNode), 0.5), this.scale), J.$mul$n(J.$add$ns(t3.get$y(foundGoalNode), 0.5), this.scale));
    for (; t3 = J.getInterceptor$x(foundGoalNode), t3.get$parent(foundGoalNode) != null;) {
      foundGoalNode = t3.get$parent(foundGoalNode);
      t3 = J.getInterceptor$x(foundGoalNode);
      t2.lineTo(J.$mul$n(J.$add$ns(t3.get$x(foundGoalNode), 0.5), this.scale), J.$mul$n(J.$add$ns(t3.get$y(foundGoalNode), 0.5), this.scale));
    }
    t2.strokeStyle = t1;
    t2.lineWidth = this.PATH_WIDTH;
    t2.stroke();
    t2.closePath();
  }
},
...
_MessageTraverser: {"": "Object;",
  ...
  _dispatch$1: function(x) {
    ...
    if (typeof x === "object" && x !== null && !!t1.$isMap0)
...
ImageElement: {"": "HtmlElement;height}-,width}-,x=-,y=-", "%": "HTMLImageElement"},
...
TextPositioningElement: {"": "TextContentElement;x=-,y=-", "%": "SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement|SVGTextPositioningElement"},
...
_RectangleBase: {"": "Object;",
  toString$0: function(_) {
    return "Rectangle (" + H.S(this.get$left()) + ", " + H.S(this.get$top(this)) + ") " + H.S(this.get$width(this)) + " x " + H.S(this.get$height(this));
  },
  $eq: function(_, other) {
    var t1, t2;
    if (other == null)
...
init.globalFunctions.main$closure = U.main$closure = new U.Closure$0(U.main, "main$closure");
init.globalFunctions.clearMap$closure = U.clearMap$closure = new U.Closure$1(U.clearMap, "clearMap$closure");
init.globalFunctions.canvasMouseDown$closure = U.canvasMouseDown$closure = new U.Closure$1(U.canvasMouseDown, "canvasMouseDown$closure");
init.globalFunctions.canvasMouseUp$closure = U.canvasMouseUp$closure = new U.Closure$1(U.canvasMouseUp, "canvasMouseUp$closure");
init.globalFunctions.canvasMouseMove$closure = U.canvasMouseMove$closure = new U.Closure$1(U.canvasMouseMove, "canvasMouseMove$closure");
...
init.globalFunctions.Primitives__throwFormatException$closure = H.Primitives__throwFormatException$closure = new U.Closure$1(H.Primitives__throwFormatException, "Primitives__throwFormatException$closure");
init.globalFunctions.toStringWrapper$closure = H.toStringWrapper$closure = new U.Closure$0(H.toStringWrapper, "toStringWrapper$closure");
init.globalFunctions.invokeClosure$closure = H.invokeClosure$closure = new H.Closure$7(H.invokeClosure, "invokeClosure$closure");
init.globalFunctions.typeNameInChrome$closure = H.typeNameInChrome$closure = new U.Closure$1(H.typeNameInChrome, "typeNameInChrome$closure");
init.globalFunctions.typeNameInSafari$closure = H.typeNameInSafari$closure = new U.Closure$1(H.typeNameInSafari, "typeNameInSafari$closure");
init.globalFunctions.typeNameInOpera$closure = H.typeNameInOpera$closure = new U.Closure$1(H.typeNameInOpera, "typeNameInOpera$closure");
init.globalFunctions.typeNameInFirefox$closure = H.typeNameInFirefox$closure = new U.Closure$1(H.typeNameInFirefox, "typeNameInFirefox$closure");
init.globalFunctions.typeNameInIE$closure = H.typeNameInIE$closure = new U.Closure$1(H.typeNameInIE, "typeNameInIE$closure");
init.globalFunctions.constructorNameFallback$closure = H.constructorNameFallback$closure = new U.Closure$1(H.constructorNameFallback, "constructorNameFallback$closure");
...
init.globalFunctions._asyncRunCallback$closure = P._asyncRunCallback$closure = new U.Closure$0(P._asyncRunCallback, "_asyncRunCallback$closure");
...
// Native classes
J.Interceptor["%"] = "CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList";
...
function dart_precompiled($collectedClasses) {
  ...
  function AStar(COST_STRAIGHT, COST_DIAGONAL, map) {
    this.COST_STRAIGHT = COST_STRAIGHT;
    this.COST_DIAGONAL = COST_DIAGONAL;
    this.map = map;
  }
  AStar.builtin$cls = "AStar";
  if (!"name" in AStar)
    AStar.name = "AStar";
  $desc = $collectedClasses.AStar;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AStar.prototype = $desc;
  function AStarNode(parent, g, f, x, y) {
    this.parent = parent;
    this.g = g;
    this.f = f;
    this.x = x;
  ...
  function Map(BACKGROUND_COLOR, OBSTACLE_COLOR, PATH_COLOR, VISITED_COLOR, PATH_WIDTH, OBSTACLE_BRUSH_SIZE, context, obstacleMap, width, height, scale) {
  ...
  MapNode.builtin$cls = "MapNode";
  if (!"name" in MapNode)
    MapNode.name = "MapNode";
  $desc = $collectedClasses.MapNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MapNode.prototype = $desc;
  MapNode.prototype.get$x = function(receiver) {
    return this.x;
  };
  MapNode.prototype.get$y = function(receiver) {
    return this.y;
  };
