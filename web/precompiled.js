...
$$.Closure$main = [R, {"": "Closure;call$0,$name", $is_void_: true}];

$$.Closure$clearMap = [R, {"": "Closure;call$1,$name"}];

$$.Closure$canvasMouseDown = [R, {"": "Closure;call$1,$name"}];

$$.Closure$canvasMouseUp = [R, {"": "Closure;call$1,$name"}];

$$.Closure$canvasMouseMove = [R, {"": "Closure;call$1,$name"}];
...
["AstarMap", "array2d.dart", , M, {
Array2d: {"": "Object;array-,defaultValue-",
  $index: function(_, x) {
    var t1 = this.array;
  ...
  set$width: function(_, v) {
    ...
    for (t1 = this.defaultValue; this.array.length < v;) {
      $arguments = H.substitute(this.$asArray2d, H.getRuntimeTypeInfo(this));
      t2 = $arguments == null ? null : $arguments[0];
      newList = P.List_List(null, t2);
      $arguments = H.substitute(this.$asArray2d, H.getRuntimeTypeInfo(this));
      t2 = $arguments == null ? null : $arguments[0];
      newList.$builtinTypeInfo = [t2];
  ...
  set$height: function(_, v) {
    var x, t1, t2;
    if (typeof v !== "number")
      return this.set$height$bailout(1, v);
  ...
  set$height$bailout: function(state0, v) {
    var x, t1, t2;
    for (; J.$gt$n(J.get$length$asx(C.JSArray_methods.get$first(this.array)), v);)
      for (x = 0; t1 = this.array, x < t1.length; ++x) {
        t1 = t1[x];
  ...
  Array2d$3$defaultValue: function(width, height, defaultValue, $T) {
    var t1 = P.List_List(null, [J.JSArray, $T]);
    H.setRuntimeTypeInfo(t1, [[J.JSArray, $T]]);
    this.array = t1;
    this.set$width(this, width);
    this.set$height(this, height);
  },
  static: {
Array2d$: function(width, height, defaultValue, $T) {
  var t1 = new M.Array2d(null, defaultValue);
...
["AstarMap", "astarmap.dart", , M, {
AstarMap: {"": "Object;BACKGROUND_COLOR-,OBSTACLE_COLOR-,PATH_COLOR-,VISITED_COLOR-,PATH_WIDTH-,OBSTACLE_BRUSH_SIZE-,COST_STRAIGHT-,COST_DIAGONAL-,context-,obstacleMap-,width-,height-,scale-",
  initObstacleMap$0: function() {
    this.obstacleMap = M.Array2d$(this.width, this.height, true, J.JSBool);
  },
  resize$3: function(width, height, scale) {
    var resetMap = !J.$eq(this.width, width) || !J.$eq(this.height, height);
    this.width = width;
    this.height = height;
    this.scale = scale;
    if (resetMap)
      this.initObstacleMap$0();
  },
  clear$0: function(_) {
    var t1, t2, t3, x, y, t4;
    t1 = this.context;
    t1.fillStyle = this.BACKGROUND_COLOR;
    t2 = t1.canvas;
  ...
  clearPath$0: function() {
    var t1, t2;
    t1 = this.context;
    t1.fillStyle = this.BACKGROUND_COLOR;
    t2 = t1.canvas;
    t1.fillRect(0, 0, t2.width, t2.height);
    this.drawObstacles$0();
  },
  drawObstacles$0: function() {
    var t1, t2, x, t3, y;
    t1 = this.OBSTACLE_COLOR;
    t2 = this.context;
    x = 0;
    while (true) {
      t3 = this.width;
  ...
  placeObstacles$1: function(e) {
    var t1, t2, t3, t4, t5, mouseX, mouseY, x, y, t6, t7, y0, t8;
    t1 = J.getInterceptor$x(e);
    t2 = t1.get$clientX(e);
    t3 = this.context;
    t4 = t3.canvas.offsetLeft;
    if (t2 == null)
      throw t2.$sub();
    if (t4 == null)
      throw H.iae(t4);
    ...
    if (typeof t5 !== "number")
      throw H.iae(t5);
    mouseX = C.JSNumber_methods.toInt$0(Math.floor((t2 - t4) / t5));
    t5 = new W.Point(t1.get$_clientX(e), t1.get$_clientY(e)).y;
    t4 = t3.canvas.offsetTop;
    if (t5 == null)
      throw t5.$sub();
    if (t4 == null)
      throw H.iae(t4);
    ...
    if (typeof t2 !== "number")
      throw H.iae(t2);
    mouseY = C.JSNumber_methods.toInt$0(Math.floor((t5 - t4) / t2));
    t2 = this.OBSTACLE_BRUSH_SIZE;
    x = mouseX - t2;
    if (x !== (x | 0))
      return this.placeObstacles$1$bailout(1, e, t3, mouseX, t1, x, mouseY, t2);
    t4 = mouseX + t2;
    y = mouseY - t2;
    if (y !== (y | 0))
      return this.placeObstacles$1$bailout(2, e, t3, 0, t1, x, mouseY, t2, t4, y);
    t2 = mouseY + t2;
    t5 = this.BACKGROUND_COLOR;
    t6 = this.OBSTACLE_COLOR;
    for (; x <= t4; ++x)
      for (t7 = x >= 0, y0 = y; y0 <= t2; ++y0) {
        t8 = t1.get$button(e);
        if (t8 === 0) {
          if (t7) {
            t8 = this.width;
            ...
            t8 = false;
          if (t8) {
            t8 = this.obstacleMap.array;
            if (x < 0 || x >= t8.length)
              throw H.ioore(t8, x);
            t8 = t8[x];
            if (y0 < 0 || y0 >= t8.length)
              throw H.ioore(t8, y0);
            t8 = t8[y0] === true;
          } else
            t8 = false;
  ...
  placeObstacles$1$bailout: function(state0, e, t3, mouseX, t1, x, mouseY, t2, t4, y) {
    switch (state0) {
      case 0:
        t1 = J.getInterceptor$x(e);
        t2 = t1.get$clientX(e);
        ...
        for (; x <= t4; ++x)
          for (t7 = x >= 0, y0 = y; y0 <= t2; ++y0) {
            ...
            if (t8 === 0) {
              ...
              if (t8) {
                t8 = this.obstacleMap.array;
                if (x >>> 0 !== x || x >= t8.length)
                  throw H.ioore(t8, x);
                t8 = t8[x];
                if (y0 >>> 0 !== y0 || y0 >= t8.length)
                  throw H.ioore(t8, y0);
                t8 = t8[y0] === true;
              } else
                t8 = false;
  ...
  astar$2: function(start, goal) {
    var $closed, $open, t1, t2, t3, lowestF, i, t4, t5, current, info, neighbors, index;
    $closed = [];
    $open = [start];
    C.JSArray_methods.get$first($open).set$f(C.JSArray_methods.get$first($open).get$g() + this.diagonalDistance$2(C.JSArray_methods.get$first($open), goal));
    for (t1 = this.VISITED_COLOR, t2 = this.context; t3 = $open.length, t3 > 0;) {
      for (lowestF = 0, i = 1; i < t3; ++i) {
        t4 = $open[i].get$f();
        if (lowestF < 0 || lowestF >= t3)
          throw H.ioore($open, lowestF);
        t5 = $open[lowestF].get$f();
        if (t4 == null)
          throw t4.$lt();
        if (t5 == null)
          throw H.iae(t5);
      ...
      if (t3.$eq(current, goal)) {
        this.draw$5($closed, $open, current, start, goal);
        info = "Map size = " + H.S(this.width) + "x" + H.S(this.height) + ("Total number of nodes = " + H.S(J.$mul$n(this.width, this.height))) + ("Number of nodes in open list = " + $open.length) + ("Number of nodes in closed list = " + $closed.length);
        document.querySelector("#info").textContent = info;
        return;
      }
      C.JSArray_methods.removeAt$1($open, lowestF);
      $closed.push(current);
      t4 = t3.get$x(current);
      t3 = t3.get$y(current);
      t2.fillStyle = t1;
      t4 = J.$mul$n(t4, this.scale);
      t3 = J.$mul$n(t3, this.scale);
      t5 = this.scale;
      t2.fillRect(t4, t3, t5, t5);
      neighbors = this.neighborNodes$1(current);
      for (i = 0; i < neighbors.length; ++i)
        if (this.indexOfNode$2($closed, neighbors[i]) === -1) {
          if (i >= neighbors.length)
            throw H.ioore(neighbors, i);
          index = this.indexOfNode$2($open, neighbors[i]);
          if (index === -1) {
            if (i >= neighbors.length)
              throw H.ioore(neighbors, i);
            t3 = neighbors[i];
            t3.f = t3.g + this.diagonalDistance$2(t3, goal);
            if (i >= neighbors.length)
              throw H.ioore(neighbors, i);
            ...
            t3 = neighbors[i];
            t4 = t3.g;
            if (index >>> 0 !== index || index >= $open.length)
              throw H.ioore($open, index);
            if (t4 < $open[index].get$g()) {
              t3.f = t4 + this.diagonalDistance$2(t3, goal);
              if (i >= neighbors.length)
                throw H.ioore(neighbors, i);
              t3 = neighbors[i];
    ...
    document.querySelector("#info").textContent = "No path exists";
  },
  neighborNodes$1: function(n) {
    var neighbors, t1, t2, t3, t4, t5, t6, t7, t8;
    neighbors = P.List_List(null, N.AstarNode);
    neighbors.$builtinTypeInfo = [N.AstarNode];
    t1 = J.getInterceptor$x(n);
    t2 = t1.get$x(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(1, n, t1, neighbors, t2);
    if (t2 > 0) {
      t3 = t2 - 1;
      t4 = t1.get$y(n);
      if (typeof t4 !== "number")
        return this.neighborNodes$1$bailout(3, n, t1, neighbors, t3, t4);
      if (t3 >= 0) {
        t5 = this.width;
        if (typeof t5 !== "number")
          throw H.iae(t5);
        if (t3 < t5)
          if (t4 >= 0) {
            t5 = this.height;
            if (typeof t5 !== "number")
              return this.neighborNodes$1$bailout(4, n, t1, neighbors, C.JSNumber_methods, t4, t5);
            t5 = t4 < t5;
          } else
            t5 = false;
        else
      ...
      if (t5) {
        t5 = this.obstacleMap;
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(5, n, t1, neighbors, t5, t2);
        t5 = t5.array;
        ...
        t2 = false;
      if (t2) {
        t2 = new N.AstarNode(n, t3, t4, null, null);
        t3 = t2.parent;
        t3 = t3 != null ? t3.get$g() : 0;
        t2.g = t3 + this.COST_STRAIGHT;
        neighbors.push(t2);
      }
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(7, n, t1, neighbors, t2);
      if (t2 > 0) {
        t3 = t1.get$x(n);
        if (typeof t3 !== "number")
          return this.neighborNodes$1$bailout(8, n, t1, neighbors, t3);
        t4 = t3 - 1;
        t5 = t2 - 1;
        if (t4 >= 0) {
          t6 = this.width;
        ...
        if (t6) {
          t6 = this.obstacleMap;
          if (t3 !== (t3 | 0))
            return this.neighborNodes$1$bailout(10, n, t1, neighbors, t6, t3);
          t6 = t6.array;
          if (t4 >>> 0 !== t4 || t4 >= t6.length)
            throw H.ioore(t6, t4);
          t4 = t6[t4];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(11, n, t1, neighbors, t2, t4);
      ...
      if (t3) {
        t3 = t1.get$x(n);
        if (typeof t3 !== "number")
          return this.neighborNodes$1$bailout(12, n, t1, neighbors, t3);
        t4 = t3 - 1;
        if (t4 >= 0) {
          t5 = this.width;
          if (typeof t5 !== "number")
          ...
          if (t4 < t5)
            if (t2 >= 0) {
              t5 = this.height;
              if (typeof t5 !== "number")
                return this.neighborNodes$1$bailout(14, n, t1, neighbors, C.JSNumber_methods, t2, t5);
              t5 = t2 < t5;
            } else
              t5 = false;
          else
        ...
        if (t5) {
          ...
          if (t3 >= 0) {
            t6 = this.width;
            if (typeof t6 !== "number")
              return this.neighborNodes$1$bailout(17, n, t1, neighbors, t3, t5, C.JSNumber_methods, t6);
            if (t3 < t6)
              if (t5 >= 0) {
                t6 = this.height;
                if (typeof t6 !== "number")
          ...
          if (t6) {
            t6 = this.obstacleMap;
            if (t3 !== (t3 | 0))
              return this.neighborNodes$1$bailout(18, n, t1, neighbors, t6, t3);
            t6 = t6.array;
            t7 = t6.length;
            if (t4 >>> 0 !== t4 || t4 >= t7)
              throw H.ioore(t6, t4);
            t8 = t6[t4];
            if (t2 >>> 0 !== t2 || t2 >= t8.length)
              throw H.ioore(t8, t2);
            if (t8[t2] === true) {
              if (t3 >>> 0 !== t3 || t3 >= t7)
                throw H.ioore(t6, t3);
          ...
          t3 = false;
        if (t3) {
          t2 = new N.AstarNode(n, t4, t2 - 1, null, null);
          t3 = t2.parent;
          t3 = t3 != null ? t3.get$g() : 0;
          t2.g = t3 + this.COST_DIAGONAL;
          neighbors.push(t2);
        }
      }
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(21, n, t1, neighbors, t2);
      t3 = this.height;
      if (typeof t3 !== "number")
        return this.neighborNodes$1$bailout(22, n, t1, neighbors, t2, t3);
      t4 = t2 < t3;
      if (t4) {
        t5 = t1.get$x(n);
        if (typeof t5 !== "number")
          return this.neighborNodes$1$bailout(23, n, t1, neighbors, t5);
        t6 = t5 - 1;
        t7 = t2 + 1;
        if (t6 >= 0) {
          t8 = this.width;
        ...
        if (t8) {
          t8 = this.obstacleMap;
          if (t5 !== (t5 | 0))
            return this.neighborNodes$1$bailout(25, n, t1, neighbors, t8, t5);
          t8 = t8.array;
          if (t6 >>> 0 !== t6 || t6 >= t8.length)
            throw H.ioore(t8, t6);
          t6 = t8[t6];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(26, n, t1, neighbors, t2, t6);
      ...
      if (t5) {
        t5 = t1.get$x(n);
        if (typeof t5 !== "number")
          return this.neighborNodes$1$bailout(27, n, t1, neighbors, t5);
        t6 = t5 - 1;
        if (t6 >= 0) {
          t7 = this.width;
          if (typeof t7 !== "number")
        ...
        if (t4) {
          ...
          if (t5 >= 0) {
            t7 = this.width;
            if (typeof t7 !== "number")
              return this.neighborNodes$1$bailout(32, n, t1, neighbors, t5, t4, C.JSNumber_methods, t7);
            t3 = t5 < t7 && t4 >= 0 && t4 < t3;
          } else
            t3 = false;
          if (t3) {
            t3 = this.obstacleMap;
            if (t5 !== (t5 | 0))
              return this.neighborNodes$1$bailout(33, n, t1, neighbors, t3, t5);
            t3 = t3.array;
            t7 = t3.length;
            if (t6 >>> 0 !== t6 || t6 >= t7)
              throw H.ioore(t3, t6);
          ...
          t3 = false;
        if (t3) {
          t2 = new N.AstarNode(n, t6, t2 + 1, null, null);
          t3 = t2.parent;
          t3 = t3 != null ? t3.get$g() : 0;
          t2.g = t3 + this.COST_DIAGONAL;
          neighbors.push(t2);
    ...
    t2 = t1.get$x(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(36, n, t1, neighbors, t2);
    t3 = this.width;
    if (typeof t3 !== "number")
      return this.neighborNodes$1$bailout(37, n, t1, neighbors, t2, t3);
    if (t2 < t3 - 1) {
      t4 = t2 + 1;
      t5 = t1.get$y(n);
      if (typeof t5 !== "number")
        return this.neighborNodes$1$bailout(39, n, t1, neighbors, t4, t5);
      if (t4 >= 0)
        if (t4 < t3)
          if (t5 >= 0) {
            t3 = this.height;
            if (typeof t3 !== "number")
              return this.neighborNodes$1$bailout(40, n, t1, neighbors, C.JSNumber_methods, t5, t3);
            t3 = t5 < t3;
          } else
            t3 = false;
        else
      ...
      if (t3) {
        t3 = this.obstacleMap;
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(41, n, t1, neighbors, t3, t2);
        t3 = t3.array;
        if (t4 >>> 0 !== t4 || t4 >= t3.length)
          throw H.ioore(t3, t4);
        t3 = t3[t4];
        ...
        t2 = false;
      if (t2) {
        t2 = new N.AstarNode(n, t4, t5, null, null);
        t3 = t2.parent;
        t3 = t3 != null ? t3.get$g() : 0;
        t2.g = t3 + this.COST_STRAIGHT;
        neighbors.push(t2);
      ...
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(43, n, t1, neighbors, t2);
      if (t2 > 0) {
        t3 = t1.get$x(n);
        if (typeof t3 !== "number")
          return this.neighborNodes$1$bailout(44, n, t1, neighbors, t3);
        t4 = t3 + 1;
        t5 = t2 - 1;
        if (t4 >= 0) {
          t6 = this.width;
        ...
        if (t6) {
          t6 = this.obstacleMap;
          if (t3 !== (t3 | 0))
            return this.neighborNodes$1$bailout(46, n, t1, neighbors, t6, t3);
          t6 = t6.array;
          if (t4 >>> 0 !== t4 || t4 >= t6.length)
            throw H.ioore(t6, t4);
          t4 = t6[t4];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(47, n, t1, neighbors, t2, t4);
          if (t5 >>> 0 !== t5 || t5 >= t4.length)
            throw H.ioore(t4, t5);
          t5 = t4[t5] === true;
          t3 = t5;
      ...
      if (t3) {
        t3 = t1.get$x(n);
        if (typeof t3 !== "number")
          return this.neighborNodes$1$bailout(48, n, t1, neighbors, t3);
        t4 = t3 + 1;
        if (t4 >= 0) {
          t5 = this.width;
          if (typeof t5 !== "number")
          ...
          if (t4 < t5)
            if (t2 >= 0) {
              t5 = this.height;
              if (typeof t5 !== "number")
                return this.neighborNodes$1$bailout(50, n, t1, neighbors, C.JSNumber_methods, t2, t5);
              t5 = t2 < t5;
            } else
              t5 = false;
          else
        ...
        if (t5) {
          ...
          if (t3 >= 0) {
            t6 = this.width;
            if (typeof t6 !== "number")
              return this.neighborNodes$1$bailout(53, n, t1, neighbors, t3, t5, C.JSNumber_methods, t6);
            if (t3 < t6)
              if (t5 >= 0) {
                t6 = this.height;
                if (typeof t6 !== "number")
          ...
          if (t6) {
            t6 = this.obstacleMap;
            if (t3 !== (t3 | 0))
              return this.neighborNodes$1$bailout(54, n, t1, neighbors, t6, t3);
            t6 = t6.array;
            t7 = t6.length;
            if (t4 >>> 0 !== t4 || t4 >= t7)
              throw H.ioore(t6, t4);
      ...
      t2 = t1.get$y(n);
      if (typeof t2 !== "number")
        return this.neighborNodes$1$bailout(57, n, t1, neighbors, t2);
      t3 = this.height;
      if (typeof t3 !== "number")
        return this.neighborNodes$1$bailout(58, n, t1, neighbors, t2, t3);
      t4 = t2 < t3;
      if (t4) {
        t5 = t1.get$x(n);
        if (typeof t5 !== "number")
          return this.neighborNodes$1$bailout(59, n, t1, neighbors, t5);
        t6 = t5 + 1;
        t7 = t2 + 1;
        if (t6 >= 0) {
          t8 = this.width;
        ...
        if (t8) {
          t8 = this.obstacleMap;
          if (t5 !== (t5 | 0))
            return this.neighborNodes$1$bailout(61, n, t1, neighbors, t8, t5);
          t8 = t8.array;
          if (t6 >>> 0 !== t6 || t6 >= t8.length)
            throw H.ioore(t8, t6);
          t6 = t8[t6];
          if (t2 !== (t2 | 0))
            return this.neighborNodes$1$bailout(62, n, t1, neighbors, t2, t6);
          if (t7 >>> 0 !== t7 || t7 >= t6.length)
            throw H.ioore(t6, t7);
          t7 = t6[t7] === true;
          t5 = t7;
      ...
      if (t5) {
        t5 = t1.get$x(n);
        if (typeof t5 !== "number")
          return this.neighborNodes$1$bailout(63, n, t1, neighbors, t5);
        t6 = t5 + 1;
        if (t6 >= 0) {
          t7 = this.width;
          if (typeof t7 !== "number")
        ...
        if (t4) {
          ...
          if (t5 >= 0) {
            t7 = this.width;
            if (typeof t7 !== "number")
              return this.neighborNodes$1$bailout(68, n, t1, neighbors, t5, t4, C.JSNumber_methods, t7);
            t3 = t5 < t7 && t4 >= 0 && t4 < t3;
          } else
            t3 = false;
          if (t3) {
            t3 = this.obstacleMap;
            if (t5 !== (t5 | 0))
              return this.neighborNodes$1$bailout(69, n, t1, neighbors, t3, t5);
            t3 = t3.array;
            t7 = t3.length;
            if (t6 >>> 0 !== t6 || t6 >= t7)
              throw H.ioore(t3, t6);
    ...
    t2 = t1.get$y(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(72, n, t1, neighbors, t2);
    if (t2 > 0) {
      t3 = t1.get$x(n);
      if (typeof t3 !== "number")
        return this.neighborNodes$1$bailout(73, n, t1, neighbors, t3);
      t4 = t2 - 1;
      if (t3 >= 0) {
        t5 = this.width;
        if (typeof t5 !== "number")
          return this.neighborNodes$1$bailout(75, n, t1, neighbors, t3, t4, C.JSNumber_methods, t5);
        if (t3 < t5)
          if (t4 >= 0) {
            t5 = this.height;
            if (typeof t5 !== "number")
        ...
        t5 = false;
      if (t5) {
        t5 = this.obstacleMap.array;
        if (t3 >>> 0 !== t3 || t3 >= t5.length)
          throw H.ioore(t5, t3);
        t3 = t5[t3];
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(76, n, t1, neighbors, t2, t3);
        if (t4 >>> 0 !== t4 || t4 >= t3.length)
          throw H.ioore(t3, t4);
        t4 = t3[t4] === true;
        t3 = t4;
      ...
      t3 = false;
    if (t3) {
      t2 = new N.AstarNode(n, t1.get$x(n), t2 - 1, null, null);
      t3 = t2.parent;
      t3 = t3 != null ? t3.get$g() : 0;
      t2.g = t3 + this.COST_STRAIGHT;
      neighbors.push(t2);
    ...
    t2 = t1.get$y(n);
    if (typeof t2 !== "number")
      return this.neighborNodes$1$bailout(78, n, t1, neighbors, t2);
    t3 = this.height;
    if (typeof t3 !== "number")
      return this.neighborNodes$1$bailout(79, n, t1, neighbors, t2, t3);
    if (t2 < t3 - 1) {
      t4 = t1.get$x(n);
      if (typeof t4 !== "number")
        return this.neighborNodes$1$bailout(80, n, t1, neighbors, t4);
      t5 = t2 + 1;
      if (t4 >= 0) {
        t6 = this.width;
        if (typeof t6 !== "number")
          return this.neighborNodes$1$bailout(82, n, t1, neighbors, t4, t5, C.JSNumber_methods, t6);
        t3 = t4 < t6 && t5 >= 0 && t5 < t3;
      } else
        t3 = false;
      if (t3) {
        ...
        t4 = t3[t4];
        if (t2 !== (t2 | 0))
          return this.neighborNodes$1$bailout(83, n, t1, neighbors, t2, t4);
        if (t5 >>> 0 !== t5 || t5 >= t4.length)
          throw H.ioore(t4, t5);
        t5 = t4[t5] === true;
        t3 = t5;
      ...
      t3 = false;
    if (t3) {
      t1 = new N.AstarNode(n, t1.get$x(n), t2 + 1, null, null);
      t2 = t1.parent;
      t2 = t2 != null ? t2.get$g() : 0;
      t1.g = t2 + this.COST_STRAIGHT;
      neighbors.push(t1);
    }
    return neighbors;
  },
  neighborNodes$1$bailout: function(state0, n, t1, neighbors, t2, t3, t4, t5) {
    switch (state0) {
      case 0:
        neighbors = P.List_List(null, N.AstarNode);
        neighbors.$builtinTypeInfo = [N.AstarNode];
      ...
      case 1:
        state0 = 0;
      default:
        if (state0 === 35 || state0 === 34 || state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 29 || state0 === 28 || state0 === 27 || state0 === 26 || state0 === 25 || state0 === 24 || state0 === 23 || state0 === 22 || state0 === 21 || state0 === 20 || state0 === 19 || state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 2 || state0 === 0 && J.$gt$n(t2, 0))
          switch (state0) {
            case 0:
              t2 = t1.get$x(n);
            case 2:
            ...
            case 4:
              if (state0 === 4 || state0 === 0 && t4.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t5 = this.width;
                    if (typeof t5 !== "number")
                      throw H.iae(t5);
                  case 4:
                    if (state0 === 4 || state0 === 0 && t4.$lt(t2, t5))
                      switch (state0) {
                        case 0:
                          t2 = J.getInterceptor$n(t3);
                        case 4:
                          if (state0 === 4 || state0 === 0 && t2.$ge(t3, 0))
                            switch (state0) {
                              case 0:
                                t4 = this.height;
                              case 4:
            ...
            case 6:
              if (state0 === 6 || state0 === 0 && t2)
                switch (state0) {
                  ...
                  case 6:
                    state0 = 0;
                    t2 = new N.AstarNode(n, J.$sub$n(t2, 1), t1.get$y(n), null, null);
                    t3 = t2.parent;
                    t3 = t3 != null ? t3.get$g() : 0;
                    t2.g = t3 + this.COST_STRAIGHT;
                    neighbors.push(t2);
            ...
            case 7:
              state0 = 0;
            default:
              if (state0 === 11 || state0 === 10 || state0 === 9 || state0 === 8 || state0 === 0 && J.$gt$n(t2, 0))
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 8:
                  ...
                  case 9:
                    ...
                    if (t4.$ge(t2, 0)) {
                      ...
                      t2 = false;
                  default:
                    if (state0 === 11 || state0 === 10 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = this.obstacleMap;
                          t3 = t1.get$x(n);
            ...
            case 19:
            case 20:
              if (state0 === 20 || state0 === 19 || state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 14 || state0 === 13 || state0 === 12 || state0 === 0 && t2)
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 12:
                  ...
                  case 13:
                    ...
                    t4 = J.getInterceptor$n(t2);
                  case 14:
                    if (state0 === 14 || state0 === 0 && t4.$ge(t2, 0))
                      switch (state0) {
                        case 0:
                          t5 = this.width;
                          if (typeof t5 !== "number")
                            throw H.iae(t5);
                        case 14:
                          if (state0 === 14 || state0 === 0 && t4.$lt(t2, t5))
                            switch (state0) {
                              case 0:
                                t2 = J.getInterceptor$n(t3);
                              case 14:
                                if (state0 === 14 || state0 === 0 && t2.$ge(t3, 0))
                                  switch (state0) {
                                    case 0:
                                      t4 = this.height;
                                    case 14:
                      ...
                      t2 = false;
                  default:
                    if (state0 === 18 || state0 === 17 || state0 === 16 || state0 === 15 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 15:
                        ...
                        case 16:
                          ...
                          t4 = J.getInterceptor$n(t2);
                        case 17:
                          if (state0 === 17 || state0 === 0 && t4.$ge(t2, 0))
                            switch (state0) {
                              case 0:
                                t5 = this.width;
                              case 17:
                  ...
                  case 19:
                  case 20:
                    if (state0 === 20 || state0 === 19 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 19:
                        ...
                        case 20:
                          state0 = 0;
                          t3 = new N.AstarNode(n, t2, J.$sub$n(t3, 1), null, null);
                          t2 = t3.parent;
                          t2 = t2 != null ? t2.get$g() : 0;
                          t3.g = t2 + this.COST_DIAGONAL;
                          neighbors.push(t3);
                      }
                }
              t2 = t1.get$y(n);
            ...
            case 25:
            case 26:
              if (state0 === 26 || state0 === 25 || state0 === 24 || state0 === 23 || state0 === 0 && J.$lt$n(t2, t3))
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 23:
                  ...
                  case 24:
                    ...
                    if (t4.$ge(t2, 0)) {
                      ...
                      t2 = false;
                  default:
                    if (state0 === 26 || state0 === 25 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = this.obstacleMap;
                          t3 = t1.get$x(n);
            ...
            case 34:
            case 35:
              if (state0 === 35 || state0 === 34 || state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 29 || state0 === 28 || state0 === 27 || state0 === 0 && t2)
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 27:
                  ...
                  case 28:
                    ...
                    t4 = J.getInterceptor$n(t2);
                  case 29:
                    if (state0 === 29 || state0 === 0 && t4.$ge(t2, 0))
                      switch (state0) {
                        case 0:
                          t5 = this.width;
                          if (typeof t5 !== "number")
                            throw H.iae(t5);
                        case 29:
                          if (state0 === 29 || state0 === 0 && t4.$lt(t2, t5))
                            switch (state0) {
                              case 0:
                                t2 = J.getInterceptor$n(t3);
                              case 29:
                                if (state0 === 29 || state0 === 0 && t2.$ge(t3, 0))
                                  switch (state0) {
                                    case 0:
                                      t4 = this.height;
                                    case 29:
                      ...
                      t2 = false;
                  default:
                    if (state0 === 33 || state0 === 32 || state0 === 31 || state0 === 30 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 30:
                        ...
                        case 31:
                          ...
                          t4 = J.getInterceptor$n(t2);
                        case 32:
                          if (state0 === 32 || state0 === 0 && t4.$ge(t2, 0))
                            switch (state0) {
                              case 0:
                                t5 = this.width;
                              case 32:
                  ...
                  case 34:
                  case 35:
                    if (state0 === 35 || state0 === 34 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 34:
                        ...
                        case 35:
                          state0 = 0;
                          t3 = new N.AstarNode(n, t2, J.$add$ns(t3, 1), null, null);
                          t2 = t3.parent;
                          t2 = t2 != null ? t2.get$g() : 0;
                          t3.g = t2 + this.COST_DIAGONAL;
                          neighbors.push(t3);
      ...
      case 70:
      case 71:
        if (state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 65 || state0 === 64 || state0 === 63 || state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 58 || state0 === 57 || state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 49 || state0 === 48 || state0 === 47 || state0 === 46 || state0 === 45 || state0 === 44 || state0 === 43 || state0 === 42 || state0 === 41 || state0 === 40 || state0 === 39 || state0 === 38 || state0 === 0 && J.$lt$n(t2, J.$sub$n(t3, 1)))
          switch (state0) {
            case 0:
              t2 = t1.get$x(n);
            case 38:
            ...
            case 39:
              ...
              t4 = J.getInterceptor$n(t2);
            case 40:
              if (state0 === 40 || state0 === 0 && t4.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t5 = this.width;
                    if (typeof t5 !== "number")
                      throw H.iae(t5);
                  case 40:
                    if (state0 === 40 || state0 === 0 && t4.$lt(t2, t5))
                      switch (state0) {
                        case 0:
                          t2 = J.getInterceptor$n(t3);
                        case 40:
                          if (state0 === 40 || state0 === 0 && t2.$ge(t3, 0))
                            switch (state0) {
                              case 0:
                                t4 = this.height;
                              case 40:
            ...
            case 41:
              if (state0 === 41 || state0 === 0 && t2)
                ...
                t2 = false;
            case 42:
              if (state0 === 42 || state0 === 0 && t2)
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 42:
                    state0 = 0;
                    t2 = new N.AstarNode(n, J.$add$ns(t2, 1), t1.get$y(n), null, null);
                    t3 = t2.parent;
                    t3 = t3 != null ? t3.get$g() : 0;
                    t2.g = t3 + this.COST_STRAIGHT;
                    neighbors.push(t2);
            ...
            case 43:
              state0 = 0;
            default:
              if (state0 === 47 || state0 === 46 || state0 === 45 || state0 === 44 || state0 === 0 && J.$gt$n(t2, 0))
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 44:
                  ...
                  case 45:
                    ...
                    if (t4.$ge(t2, 0)) {
                      ...
                      t2 = false;
                  default:
                    if (state0 === 47 || state0 === 46 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = this.obstacleMap;
                          t3 = t1.get$x(n);
            ...
            case 55:
            case 56:
              if (state0 === 56 || state0 === 55 || state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 50 || state0 === 49 || state0 === 48 || state0 === 0 && t2)
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 48:
                  ...
                  case 49:
                    ...
                    t4 = J.getInterceptor$n(t2);
                  case 50:
                    if (state0 === 50 || state0 === 0 && t4.$ge(t2, 0))
                      switch (state0) {
                        case 0:
                          t5 = this.width;
                          if (typeof t5 !== "number")
                            throw H.iae(t5);
                        case 50:
                          if (state0 === 50 || state0 === 0 && t4.$lt(t2, t5))
                            switch (state0) {
                              case 0:
                                t2 = J.getInterceptor$n(t3);
                              case 50:
                                if (state0 === 50 || state0 === 0 && t2.$ge(t3, 0))
                                  switch (state0) {
                                    case 0:
                                      t4 = this.height;
                                    case 50:
                      ...
                      t2 = false;
                  default:
                    if (state0 === 54 || state0 === 53 || state0 === 52 || state0 === 51 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 51:
                        ...
                        case 52:
                          ...
                          t4 = J.getInterceptor$n(t2);
                        case 53:
                          if (state0 === 53 || state0 === 0 && t4.$ge(t2, 0))
                            switch (state0) {
                              case 0:
                                t5 = this.width;
                              case 53:
                  ...
                  case 55:
                  case 56:
                    if (state0 === 56 || state0 === 55 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 55:
            ...
            case 61:
            case 62:
              if (state0 === 62 || state0 === 61 || state0 === 60 || state0 === 59 || state0 === 0 && J.$lt$n(t2, t3))
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 59:
                  ...
                  case 60:
                    ...
                    if (t4.$ge(t2, 0)) {
                      ...
                      t2 = false;
                  default:
                    if (state0 === 62 || state0 === 61 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = this.obstacleMap;
                          t3 = t1.get$x(n);
            ...
            case 70:
            case 71:
              if (state0 === 71 || state0 === 70 || state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 65 || state0 === 64 || state0 === 63 || state0 === 0 && t2)
                switch (state0) {
                  case 0:
                    t2 = t1.get$x(n);
                  case 63:
                  ...
                  case 64:
                    ...
                    t4 = J.getInterceptor$n(t2);
                  case 65:
                    if (state0 === 65 || state0 === 0 && t4.$ge(t2, 0))
                      switch (state0) {
                        case 0:
                          t5 = this.width;
                          if (typeof t5 !== "number")
                            throw H.iae(t5);
                        case 65:
                          if (state0 === 65 || state0 === 0 && t4.$lt(t2, t5))
                            switch (state0) {
                              case 0:
                                t2 = J.getInterceptor$n(t3);
                              case 65:
                                if (state0 === 65 || state0 === 0 && t2.$ge(t3, 0))
                                  switch (state0) {
                                    case 0:
                                      t4 = this.height;
                                    case 65:
                      ...
                      t2 = false;
                  default:
                    if (state0 === 69 || state0 === 68 || state0 === 67 || state0 === 66 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 66:
                        ...
                        case 67:
                          ...
                          t4 = J.getInterceptor$n(t2);
                        case 68:
                          if (state0 === 68 || state0 === 0 && t4.$ge(t2, 0))
                            switch (state0) {
                              case 0:
                                t5 = this.width;
                              case 68:
                  ...
                  case 70:
                  case 71:
                    if (state0 === 71 || state0 === 70 || state0 === 0 && t2)
                      switch (state0) {
                        case 0:
                          t2 = t1.get$x(n);
                        case 70:
      ...
      case 75:
      case 76:
        if (state0 === 76 || state0 === 75 || state0 === 74 || state0 === 73 || state0 === 0 && J.$gt$n(t2, 0))
          switch (state0) {
            case 0:
              t2 = t1.get$x(n);
            case 73:
            ...
            case 74:
              ...
              t4 = J.getInterceptor$n(t2);
            case 75:
              if (state0 === 75 || state0 === 0 && t4.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t5 = this.width;
                  case 75:
      ...
      case 82:
      case 83:
        if (state0 === 83 || state0 === 82 || state0 === 81 || state0 === 80 || state0 === 0 && J.$lt$n(t2, J.$sub$n(t3, 1)))
          switch (state0) {
            case 0:
              t2 = t1.get$x(n);
            case 80:
            ...
            case 81:
              ...
              t4 = J.getInterceptor$n(t2);
            case 82:
              if (state0 === 82 || state0 === 0 && t4.$ge(t2, 0))
                switch (state0) {
                  case 0:
                    t5 = this.width;
                  case 82:
      ...
      case 84:
        if (state0 === 84 || state0 === 0 && t2)
          switch (state0) {
            ...
            case 84:
              state0 = 0;
              t1 = new N.AstarNode(n, t2, J.$add$ns(t1, 1), null, null);
              t2 = t1.parent;
              t2 = t2 != null ? t2.get$g() : 0;
              t1.g = t2 + this.COST_STRAIGHT;
              neighbors.push(t1);
  ...
  indexOfNode$2: function(array, node) {
    var t1, i;
    for (t1 = J.getInterceptor(node), i = 0; i < array.length; ++i)
      if (t1.$eq(node, array[i]))
        return i;
    return -1;
  },
  draw$5: function($closed, $open, foundGoalNode, start, goal) {
    var t1, t2, t3, t4, t5;
    t1 = goal.x;
    if (typeof t1 !== "number")
      return this.draw$5$bailout(1, foundGoalNode, start, t1, goal);
    t2 = goal.y;
    if (typeof t2 !== "number")
      return this.draw$5$bailout(2, foundGoalNode, start, t1, 0, t2);
    t3 = this.PATH_COLOR;
    t4 = this.context;
    t4.fillStyle = t3;
    t5 = this.scale;
    if (typeof t5 !== "number")
      return this.draw$5$bailout(3, foundGoalNode, start, t1, 0, t2, t3, t4, t5);
    t4.fillRect(t1 * t5, t2 * t5, t5, t5);
    t5 = start.x;
    if (typeof t5 !== "number")
      return this.draw$5$bailout(5, foundGoalNode, start, 0, 0, t5, t3, t4);
    t2 = start.y;
    if (typeof t2 !== "number")
      return this.draw$5$bailout(6, foundGoalNode, 0, t2, 0, t5, t3, t4);
    t4.fillStyle = t3;
    t1 = this.scale;
    if (typeof t1 !== "number")
      return this.draw$5$bailout(7, foundGoalNode, 0, t2, 0, t5, t3, t4, t1);
    t4.fillRect(t5 * t1, t2 * t1, t1, t1);
    t4.beginPath();
    t1 = J.getInterceptor$x(foundGoalNode);
    t2 = t1.get$x(foundGoalNode);
    if (typeof t2 !== "number")
      return this.draw$5$bailout(9, foundGoalNode, 0, t1, 0, t2, t3, t4);
    t5 = this.scale;
    if (typeof t5 !== "number")
      throw H.iae(t5);
    t2 = (t2 + 0.5) * t5;
    t1 = t1.get$y(foundGoalNode);
    if (typeof t1 !== "number")
      return this.draw$5$bailout(10, foundGoalNode, 0, t1, 0, 0, t3, t4, t2);
    t4.moveTo(t2, (t1 + 0.5) * t5);
    for (; t1 = J.getInterceptor$x(foundGoalNode), t1.get$parent(foundGoalNode) != null;) {
      foundGoalNode = t1.get$parent(foundGoalNode);
      t1 = J.getInterceptor$x(foundGoalNode);
      t2 = t1.get$x(foundGoalNode);
      if (typeof t2 !== "number")
        return this.draw$5$bailout(11, foundGoalNode, 0, t1, 0, t2, t3, t4);
      t5 = this.scale;
      if (typeof t5 !== "number")
        throw H.iae(t5);
      t2 = (t2 + 0.5) * t5;
      t1 = t1.get$y(foundGoalNode);
      if (typeof t1 !== "number")
        return this.draw$5$bailout(12, foundGoalNode, 0, t1, 0, 0, t3, t4, t2);
      t4.lineTo(t2, (t1 + 0.5) * t5);
    }
    t4.strokeStyle = t3;
    t4.lineWidth = this.PATH_WIDTH;
    t4.stroke();
    t4.closePath();
  },
  draw$5$bailout: function(state0, foundGoalNode, start, t1, goal, t2, t3, t4, t5) {
    switch (state0) {
      case 0:
        t1 = goal.x;
      case 1:
        ...
        L0:
          while (true)
            switch (state0) {
              case 0:
                t1 = J.getInterceptor$x(foundGoalNode);
                if (!(t1.get$parent(foundGoalNode) != null))
                  break L0;
                foundGoalNode = t1.get$parent(foundGoalNode);
                t1 = J.getInterceptor$x(foundGoalNode);
                t2 = t1.get$x(foundGoalNode);
  ...
  diagonalDistance$2: function(node, goal) {
    var t1, t2, t3, t4, t5, dmin;
    t1 = J.getInterceptor$x(node);
    t2 = t1.get$x(node);
    t3 = goal.x;
    t2 = J.abs$0$n(J.$sub$n(t2, t3));
    t4 = t1.get$y(node);
    t5 = goal.y;
    dmin = P.min(t2, J.abs$0$n(J.$sub$n(t4, t5)));
    return this.COST_DIAGONAL * dmin + this.COST_STRAIGHT * (P.max(J.abs$0$n(J.$sub$n(t1.get$x(node), t3)), J.abs$0$n(J.$sub$n(t1.get$y(node), t5))) - dmin);
  }
}}],
["Astarnode", "astarnode.dart", , N, {
AstarNode: {"": "Object;parent>-,x>-,y>-,g<-,f@-",
  $eq: function(_, other) {
    var t1;
    if (other == null)
      return false;
...
["canvas_astar.dart", "canvas_astar.dart", , R, {
main: function() {
  var t1, t2;
  $.canvas = document.querySelector("#astar");
  R.resizeCanvas();
  $.context = H.interceptedTypeCast(J.getContext$1$x($.canvas, "2d"), "$isCanvasRenderingContext2D");
  t1 = new M.AstarMap("#EEE", "#2D2D30", "#0C0", "#44F", 4, 2, 1, 1.414, $.context, null, H.Primitives_parseInt($.mapWidth, null, null), H.Primitives_parseInt($.mapHeight, null, null), H.Primitives_parseInt($.mapScale, null, null));
  t1.initObstacleMap$0();
  t1.clear$0(t1);
  $.map = t1;
  t1 = new N.AstarNode(null, 0, 0, null, null);
  t2 = t1.parent;
  t1.g = (t2 != null ? t2.get$g() : 0) + 0;
  $.start = t1;
  t1 = new N.AstarNode(null, J.$sub$n($.map.width, 1), J.$sub$n($.map.height, 1), null, null);
  t2 = t1.parent;
  t1.g = (t2 != null ? t2.get$g() : 0) + 0;
  $.goal = t1;
  R.registerEvents($.canvas);
},

registerEvents: function(canvas) {
  var t1, t2, t3;
  canvas.get$onMouseDown;
  t1 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_mousedown._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, R.canvasMouseDown$closure, t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_mouseup._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, R.canvasMouseUp$closure, t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
  t1 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_mousemove._eventType, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, R.canvasMouseMove$closure, t1._useCapture);
  H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t2._tryResume$0();
  t2 = new W._ElementEventStreamImpl(canvas, C.EventStreamProvider_contextmenu._eventType, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t1 = new W._EventStreamSubscription(0, t2._target, t2._eventType, new R.registerEvents_closure(), t2._useCapture);
  H.setRuntimeTypeInfo(t1, [H.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
  t1._tryResume$0();
  t1 = document.querySelector("#run");
  t1.get$onClick;
  t2 = C.EventStreamProvider_click._eventType;
  t1 = new W._ElementEventStreamImpl(t1, t2, false);
  H.setRuntimeTypeInfo(t1, [null]);
  t3 = new W._EventStreamSubscription(0, t1._target, t1._eventType, new R.registerEvents_closure0(), t1._useCapture);
  H.setRuntimeTypeInfo(t3, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
  t3._tryResume$0();
  t3 = document.querySelector("#clear");
  t3.get$onClick;
  t2 = new W._ElementEventStreamImpl(t3, t2, false);
  H.setRuntimeTypeInfo(t2, [null]);
  t3 = new W._EventStreamSubscription(0, t2._target, t2._eventType, R.clearMap$closure, t2._useCapture);
...
resizeCanvas: function() {
  ...
  t2.set$width(t1, J.$mul$n(H.Primitives_parseInt($.mapScale, null, null), H.Primitives_parseInt($.mapWidth, null, null)));
  t2.set$height(t1, J.$mul$n(H.Primitives_parseInt($.mapScale, null, null), H.Primitives_parseInt($.mapHeight, null, null)));
},

resizeMap: function() {
  var t1, t2;
  $.map.resize$3(H.Primitives_parseInt($.mapWidth, null, null), H.Primitives_parseInt($.mapHeight, null, null), H.Primitives_parseInt($.mapScale, null, null));
  t1 = new N.AstarNode(null, J.$sub$n($.map.width, 1), J.$sub$n($.map.height, 1), null, null);
  t2 = t1.parent;
  t1.g = (t2 != null ? t2.get$g() : 0) + 0;
  $.goal = t1;
...
run: function() {
  ...
  R.resizeMap();
  $.map.clearPath$0();
  $.map.astar$2($.start, $.goal);
},

canvasMouseDown: function(e) {
  $.isMouseDown = true;
  $.map.placeObstacles$1(e);
},
...
registerEvents_closure: {"": "Closure;",
  call$1: function(e) {
    return J.preventDefault$0$x(e);
  }
},

registerEvents_closure0: {"": "Closure;",
  call$1: function(e) {
    return R.run();
  }
}},
...
CanvasRenderingContext2D: {"": "CanvasRenderingContext;", $isCanvasRenderingContext2D: true, $asCanvasRenderingContext2D: null},
...
InputElement: {"": "HtmlElement;height}-,width}-"},

MediaElement: {"": "HtmlElement;"},

MouseEvent: {"": "UIEvent;button=-,_clientX:clientX=-,_clientY:clientY=-",
  get$clientX: function(receiver) {
    return new W.Point(receiver.clientX, receiver.clientY).x;
  },
  $isMouseEvent: true,
  $asMouseEvent: null
},
...
init.globalFunctions.main$closure = R.main$closure = new R.Closure$main(R.main, "main$closure");
init.globalFunctions.clearMap$closure = R.clearMap$closure = new R.Closure$clearMap(R.clearMap, "clearMap$closure");
init.globalFunctions.canvasMouseDown$closure = R.canvasMouseDown$closure = new R.Closure$canvasMouseDown(R.canvasMouseDown, "canvasMouseDown$closure");
init.globalFunctions.canvasMouseUp$closure = R.canvasMouseUp$closure = new R.Closure$canvasMouseUp(R.canvasMouseUp, "canvasMouseUp$closure");
init.globalFunctions.canvasMouseMove$closure = R.canvasMouseMove$closure = new R.Closure$canvasMouseMove(R.canvasMouseMove, "canvasMouseMove$closure");
...
// Native classes
H.defineNativeMethods("CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList", J.Interceptor);
...
function dart_precompiled($collectedClasses) {
  ...
  function AstarMap(BACKGROUND_COLOR, OBSTACLE_COLOR, PATH_COLOR, VISITED_COLOR, PATH_WIDTH, OBSTACLE_BRUSH_SIZE, COST_STRAIGHT, COST_DIAGONAL, context, obstacleMap, width, height, scale) {
    this.BACKGROUND_COLOR = BACKGROUND_COLOR;
    this.OBSTACLE_COLOR = OBSTACLE_COLOR;
    this.PATH_COLOR = PATH_COLOR;
    this.VISITED_COLOR = VISITED_COLOR;
    this.PATH_WIDTH = PATH_WIDTH;
    this.OBSTACLE_BRUSH_SIZE = OBSTACLE_BRUSH_SIZE;
    this.COST_STRAIGHT = COST_STRAIGHT;
    this.COST_DIAGONAL = COST_DIAGONAL;
  ...
  AstarMap.builtin$cls = "AstarMap";
  if (!"name" in AstarMap)
    AstarMap.name = "AstarMap";
  $desc = $collectedClasses.AstarMap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AstarMap.prototype = $desc;
  function AstarNode(parent, x, y, g, f) {
    this.parent = parent;
    this.x = x;
    this.y = y;
    this.g = g;
  ...
  AstarNode.builtin$cls = "AstarNode";
  if (!"name" in AstarNode)
    AstarNode.name = "AstarNode";
  $desc = $collectedClasses.AstarNode;
  if ($desc instanceof Array)
    $desc = $desc[1];
  AstarNode.prototype = $desc;
  AstarNode.prototype.get$parent = function(receiver) {
    return this.parent;
  };
  AstarNode.prototype.get$x = function(receiver) {
    return this.x;
  };
  AstarNode.prototype.get$y = function(receiver) {
    return this.y;
  };
  AstarNode.prototype.get$g = function() {
    return this.g;
  };
  AstarNode.prototype.get$f = function() {
    return this.f;
  };
  AstarNode.prototype.set$f = function(v) {
    return this.f = v;
  };
  ...
  function registerEvents_closure() {
  }
  registerEvents_closure.builtin$cls = "registerEvents_closure";
  if (!"name" in registerEvents_closure)
    registerEvents_closure.name = "registerEvents_closure";
  $desc = $collectedClasses.registerEvents_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  registerEvents_closure.prototype = $desc;
  function registerEvents_closure0() {
  }
  registerEvents_closure0.builtin$cls = "registerEvents_closure0";
  if (!"name" in registerEvents_closure0)
    registerEvents_closure0.name = "registerEvents_closure0";
  $desc = $collectedClasses.registerEvents_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  registerEvents_closure0.prototype = $desc;
  ...
  function _ZoneTimer(_zone, _liblib2$_callback, _timer) {
    this._zone = _zone;
  ...
  MouseEvent.prototype.get$_clientY = function(receiver) {
  ...
  function Closure$clearMap(call$1, $name) {
    this.call$1 = call$1;
    this.$name = $name;
  }
  Closure$clearMap.builtin$cls = "Closure$clearMap";
  $desc = $collectedClasses.Closure$clearMap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Closure$clearMap.prototype = $desc;
  function Closure$canvasMouseDown(call$1, $name) {
    this.call$1 = call$1;
    this.$name = $name;
  }
  Closure$canvasMouseDown.builtin$cls = "Closure$canvasMouseDown";
  $desc = $collectedClasses.Closure$canvasMouseDown;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Closure$canvasMouseDown.prototype = $desc;
  function Closure$canvasMouseUp(call$1, $name) {
    this.call$1 = call$1;
    this.$name = $name;
  }
  Closure$canvasMouseUp.builtin$cls = "Closure$canvasMouseUp";
  $desc = $collectedClasses.Closure$canvasMouseUp;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Closure$canvasMouseUp.prototype = $desc;
  function Closure$canvasMouseMove(call$1, $name) {
    this.call$1 = call$1;
    this.$name = $name;
  }
  Closure$canvasMouseMove.builtin$cls = "Closure$canvasMouseMove";
  $desc = $collectedClasses.Closure$canvasMouseMove;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Closure$canvasMouseMove.prototype = $desc;
